 ...
 * @version 0.4.1
 */
public class ModuleTestClusterCoeff {
     ...
     */
    public ModuleTestClusterCoeff() {
        Debugger.printErr("Don't instantiate a test class: " + 
                            "ModuleTestClusterCoeff");
    }
    ...
    public static void main(String[] args) {
        ...
        Debugger.pipeResult("ClusterCoeffNormal.txt",
                            "ClusterCoeffError.txt");
        Debugger.enableTrace(true);                             

        Debugger.debug("\n================================\n"+
                         "filename: ClusterCoeffNormal.txt\n" +
                         "================================");
        Debugger.debug("Module Test for population.ClusterCoeff:\n");
        
        Debugger.printErr("\n===============================\n"+
                            "filename: ClusterCoeffError.txt\n" +
                            "===============================");
        Debugger.printErr("Module Test for population.ClusterCoeff:\n");
        ...
        Debugger.debug("======================================");
        Debugger.debug("Module Test for ClusterCoeff Completed");
        Debugger.debug("======================================");
        Debugger.printErr("======================================");
        Debugger.printErr("Module Test for ClusterCoeff Completed");
        Debugger.printErr("======================================");
    }
    ...
    private static void testApplication(SetOfChromosomes popA) {
        ...
        for (int i = 0; i < popA.getPopSize(); i++) {
            cc.apply( popA.getChromo(i), arrIndex);
